...
### 1. 操作指南
	...
	1. 启动游戏：运行main.py，进入主菜单。
	
	2. 游戏流程：
	
	3. 输入昵称 → 查看剧情 → 进入战斗界面。
	
	4. 点击卡牌出牌，功能牌需选择目标（如“炽热”指定怪物）。
...
#### 1. 初始界面
![初始界面](./images/初始界面.png)

- 包含开始游戏、退出游戏选项及音乐开关按钮。
- 背景图为游戏主题风格，标题使用特殊字体渲染。

#### 2. 故事情节
![故事情节](./images/故事情节.png)

#### 3. 输入昵称界面
![输入昵称界面](./images/输入昵称界面.png)

#### 4. 选择界面
![选择界面](./images/选择界面.png)
...
#### 5. 战斗界面
![战斗界面](./images/战斗界面.png)

- 显示愤怒值（>80时变红）、存活单位、手牌及消息日志。
- 玩家可通过鼠标点击选择卡牌出牌。

#### 6. 游戏结束界面
![游戏结束界面--成功](./images/游戏结束界面--成功.png)
![游戏结束界面--失败](./images/游戏结束界面--失败.png)

- 展示通关信息和金币奖励。
- 点击任意位置继续以及通过点击右上角的×退出游戏

#### 7. 卡牌界面
![卡牌界面](./images/卡牌界面.png)

- 用户可以选择单抽和十连两种抽卡模式，卡牌的信息体现在prop文件中。
- 支持滚动查看所有卡牌。

#### 8. 图鉴界面
![图鉴界面1](./images/图鉴界面1.png)
![图鉴界面2](./images/图鉴界面2.png)

- 分类展示卡牌和怪物的名称、功能及策略说明。
- 支持滚动查看所有条目。
...
| 成员(未注册github的用大写字母代替) | 个人任务（每人均为20%左右） |
| --- | --- |
